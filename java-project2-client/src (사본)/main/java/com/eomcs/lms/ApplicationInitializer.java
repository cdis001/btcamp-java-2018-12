...
import com.eomcs.lms.context.AplicationContextException;
...
public class ApplicationInitializer implements ApplicationContextListener {
  ...
  public void contextInitialized(Map<String, Object> context) {
    try {
      ...
      context.put("/member/add", new MemberListCommand(keyboard, memberDao));
      ...
      throw new AplicationContextException(e);
    }
