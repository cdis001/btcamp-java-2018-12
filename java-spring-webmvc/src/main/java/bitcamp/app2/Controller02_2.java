...
public class Controller02_2 {
  ...
  public String handler2(@PathVariable("value") String value,
      @MatrixVariable /* ("name") */ String name, @MatrixVariable /* ("age") */ int age) {
  ...
  @ResponseBody
  public String handler3(@MatrixVariable String name, @MatrixVariable int qty,
      @MatrixVariable String title, @MatrixVariable int state) {
  ...
  @ResponseBody
  public String handler4(@MatrixVariable(name = "name", pathVar = "team") String name1,
      @MatrixVariable(name = "qty", pathVar = "team") int v,
      @MatrixVariable(name = "name", pathVar = "task") String name2,
      @MatrixVariable(name = "qty", pathVar = "task") int ve) {
    return String.format("team: %s(%d)\n task: %s, %d)", name1, v, name2, ve);
  }
}
