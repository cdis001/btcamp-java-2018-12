...
public class Controller04_1 {
  ...
  @GetMapping("h1")
  @ResponseBody
  public void handler1(/* ServletContext sc, */ ServletRequest request, ServletResponse response,
      HttpServletRequest request2, HttpServletResponse response2, HttpSession session,
      Map<String, Object> map, Model model, PrintWriter out) {
