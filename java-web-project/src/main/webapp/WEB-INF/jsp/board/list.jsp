...
<body>
 ...
 <div class="container">
  <h1>게시물 목록</h1>
  <p>
   <a class="btn btn-dark btn-sm" href='form'>새 글</a>
  </p>
  <div class="bit-list">
  ...
  <nav aria-label="목록 페이지 이동">
   <ul class="pagination justify-content-center">
    ...
    <%-- <li class="page-item ${pageNo <= 1 ? 'disabled' : ''}"><a class="page-link" href="?pageNo=${pageNo - 1}&pageSize=${pageSize}">${pageNo - 1}</a></li> --%>
    <li class="page-item active"><span class="page-link">${pageNo}</span></li>
    <%-- <li class="page-item ${pageNo >= totalPage ? 'disabled' : ''}"><a class="page-link" href="?pageNo=${pageNo + 1}&pageSize=${pageSize}">${pageNo + 1}</a></li> --%>
